...
<head>
    <meta charset="UTF-8">
    <title>Add Purchase Return - CPMS</title>
...
<div class="container mt-4">
    ...
    <form action="add_purchase_return.php" method="post">
        <?php csrf_input(); ?>
        <div class="card mb-4"><div class="card-header">Return Details</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3"><label>Supplier</label>
                        <select name="supplier_id" class="form-control" required>
                            <?php foreach ($suppliers as $supplier) echo "<option value='{$supplier['id']}'>".htmlspecialchars($supplier['supplier_name'])."</option>"; ?>
                        </select>
                    </div>
        ...
        <div class="card"><div class="card-header">Products to Return</div>
        ...
        <div class="mt-3"><button type="submit" name="save_return" class="btn btn-primary">Process Return</button><a href="dashboard.php" class="btn btn-secondary">Back to Dashboard</a></div>
    </form>
</div>
<script>
